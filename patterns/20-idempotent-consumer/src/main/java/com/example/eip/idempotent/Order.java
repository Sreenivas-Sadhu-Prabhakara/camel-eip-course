 ...
 *
 * <p>The {@code orderId} is what we use as the <b>idempotency key</b> — the stable, business-meaningful
 * value that is identical across duplicate deliveries of the same order.
 */
public class Order {
