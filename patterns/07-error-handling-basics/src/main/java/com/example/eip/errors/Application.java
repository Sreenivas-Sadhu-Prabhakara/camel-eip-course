 ...
 * So adding a route is just adding a class — see {@link ErrorHandlingRoute} (the main lesson),
 * {@link DeadLetterChannelRoute} and {@link TryCatchRoute} (the two alternative strategies).
 */
